...
\end{subfigure}
\begin{subfigure}{.5\textwidth}
    \caption{Escala Log-Log (incluyendo $\beta=0$).}
    \centering
...
TODO: conectar bien estas partes, el parrafo que sigue venia conectado con la parte anterior del analisis de qué beta elegir
