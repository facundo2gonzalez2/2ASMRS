...
\includegraphics[scale=0.59]{imgs/01_arquitectura/5_recon_evolution_no_beta.png}
\end{figure}
...
\includegraphics[scale=0.59]{imgs/01_arquitectura/2_val_loss_mean_std_with_base.png}
\end{figure}
...
\centering
\label{fig:kl_vs_dim}
\includegraphics[scale=0.59]{imgs/01_arquitectura/4_beta_kl_evolution.png}
\end{figure}
...
\caption{Curva de compromiso entre error de reconstrucción y divergencia KL para la selección del hiperparámetro $\beta$.}
\label{fig:pareto}
\end{figure}
...
\begin{figure}[H]
\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{imgs/04_similitud/sim_aggregated_to_piano.png}}
...
\makebox[\textwidth][c]{%
    \begin{minipage}{1.3\textwidth}
        \begin{subfigure}{.48\linewidth}
            \centering
            \includegraphics[width=\linewidth]{imgs/04_similitud/desglose_aggregated_checkpoint_beta.png}
            \caption{\textit{Checkpoint-$\beta$-VAE} ($\beta=0.001$).}
            \label{fig:sim_aggregated_per_instrument_checkpoint}
        \end{subfigure}\hfill
        \begin{subfigure}{.48\linewidth}
            \centering
            \includegraphics[width=\linewidth]{imgs/04_similitud/desglose_aggregated_scratch_no_beta.png}
            \caption{\textit{Scratch-AE} ($\beta=0$).}
            \label{fig:sim_aggregated_per_instrument_scratch}
        \end{subfigure}
    \end{minipage}%
}
\caption{Desglose por instrumento de origen para las distintas configuraciones evaluadas.}
\label{fig:sim_aggregated_per_instrument}
\end{figure}
...
\begin{figure}[H]
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{imgs/04_similitud/sim_aggregated_to_all_instruments.png}}
...
\begin{figure}[H]
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{imgs/plots/fad_random_latent_gaussian_piano_to_guitar.png}}
